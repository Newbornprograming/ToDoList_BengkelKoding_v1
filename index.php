...
<body>
    ...
    <!--Form Input Data-->
        ...
        <form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
            ...
            <div class="col mb-2">
                <label for="tgl_ahkir" class="form-label fw-bold">
                Tanggal Ahkir
                </label>
                <input type="date" class="form-control" name="tgl_ahkir" id="tgl_ahkir" placeholder="Tanggal Ahkir" value="<?php echo $tgl_ahkir ?>">
            </div>
        ...
        <?php
            if (isset($_POST['simpan'])) {
                if (isset($_POST['id'])) {
                    ...
                    $tambah = mysqli_query($mysqli, "INSERT INTO todolist(isi,tgl_awal,tgl_ahkir,status) 
                                                    VALUES ( 
                                                        '" . $_POST['isi'] . "',
                                                        '" . $_POST['tgl_awal'] . "',
                                                        '" . $_POST['tgl_ahkir'] . "',
